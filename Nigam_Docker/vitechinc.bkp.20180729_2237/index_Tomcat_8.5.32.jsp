            ...
            <div id="upper1" class="curved container">
                ...
                <div style="text-align:left; font-family: Courier">
                    <font size="4" color="black"> 
                        ...
                        $ docker image build -f ./vitech.Tomcat.Dockerfile -t vitech/tomcat_dr .<br/> <br/>
                        $ docker container run -d -p 9090:8080 \ <br/>
                         &emsp; --hostname vitechTomcat_dr --name vitechTomcat_dr  \ <br/>
                         &emsp; -v tomcat_logs_dr:/usr/local/tomcat/logs vitech/tomcat_dr <br/> <br/>
                        ...
                        $ docker container run -it -d -p 8000:80 --link vitechTomcat_dr:vitechTomcat \ <br/>
                         &emsp; --hostname vitechApache_dr --name vitechApache_dr vitech/apache_dr <br/>
                         <br/>
